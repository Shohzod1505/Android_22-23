...
import ru.itis.kpfu.homework.databinding.ItemTodoListGridBinding

class GridTodoListHolder(
    private val binding: ItemTodoListGridBinding,
    ...
    companion object {
        ...
        ): GridTodoListHolder = GridTodoListHolder(
            binding = ItemTodoListGridBinding.inflate(
